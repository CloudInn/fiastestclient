...
FIAS::FIAS()
{
    ...
    linkRecords.append("LR|RIGI|FLRNGSG#GFGNGLGVGGGAGDGTDATINPWSG+A0A1A2A3A4A5A6A7A8A9|");
    linkRecords.append("LR|RIGO|FLRNG#GSDATIWSG+A0A1A2A3A4A5A6A7A8A9|");
    linkRecords.append("LR|RIGC|FLRORNG#GFGNGLGVGGGSGAGDGTDATINPWSG+A0A1A2A3A4A5A6A7A8A9|");
